      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="grid gap-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
            ...
            <form action="https://api.web3forms.com/submit" method="POST" className="grid gap-5 sm:grid-cols-2">
              ...
              <div className="sm:col-span-2">
                <Button type="submit" className="h-13 rounded-full px-6 text-sm font-semibold">
                  Anfrage senden
                </Button>
              </div>
            </form>
